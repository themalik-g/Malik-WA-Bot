...
async function pairCommand(sock, chatId, message, q) {
    try {
        ...
        for (const number of numbers) {
            ...
            try {
                const response = await axios.get(`https://malik-bot-paircode.onrender.com/code?number=${number}`).catch(async () => {
                    return await axios.get(`https://knight-bot-paircode.onrender.com/code?number=${number}`);
                });
